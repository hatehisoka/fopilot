...
- **Compose піднімає фронтенд у dev-режимі Vite**, а не продакшн-збірку за nginx. Це свідомий
  вибір для середовища розробки й демонстрації; продакшн-конфігурація (статична збірка, reverse
  proxy) — поза скоупом.
